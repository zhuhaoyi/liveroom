...
{
	$.jBox("iframe:<?php echo site_url('live/editRoominfo')?>"+"/"+roomid+"/"+cate, {title: "修改简�?,iframeScrolling: 'no',height: 200,width: 450,buttons: { '关闭': true }});
}
...
<div class="container_24 clearfix">
		...
		<div class="tabtop">
			...
			<span class="logindiv">
				<?php if ((!empty($userinfo)) && ($userinfo['level'] != '-1')) { ?>
					...
					<a href="<?php echo site_url("user/logout") ?>">&nbsp;<span class="orange">退�?/span></a>
					<script type="text/javascript">
					function modi()
						{
	...
	<div class="grid_10 livediv clearfix">		
		<div id="video" style="position: relative;z-index:1">
			<div class="kzzsx">
				<a title="点击刷新" href="javascript:LoadVideo();">没有声音,有杂�?看不到视频，请点刷新</a>
			</div>
		...
		<div class="zhao" style='font-family:"Microsoft YaHei",微软雅黑,"MicrosoftJhengHei",华文细黑,STHeiti,MingLiu; font-size:18px;height:40px;width:385px;padding-top:10px;margin-bottom:10px;text-align:center'>
			<span><img src="<?php echo base_url('themes/images/icon/lb.png');?>" /><a href="###" class="orange" onclick="handanlist()">实力见证请点击赢在这里在线喊单明细查�?/a></span>
		</div>
		</div>
