...
<li style="width:250px;margin:10px;"><input type="text" placeholder="帐号" style="width:220px" name="username" class="text_input us_input"/></li>\
<li style="width:250px;margin:10px;"><input type="password" placeholder="密码" style="width:220px" name="passwd" ispwd="1" class="text_input us_input"/></li>\
<li style="width:250px;height:48px;margin:10px;padding-left:25px;"><input type="submit" style="width:200px" class="btn_input us_input"  value="登 录"/></li>\
</ul>\
</form>\
</div>';
function showLoginForm(){
	TINY.box.show({html:loginform,width:300,height:250,openjs:function(){
		$('.alert_title').hide();
