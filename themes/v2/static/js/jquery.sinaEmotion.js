...
$(function() {
	...
	$.ajax( {
	    ...
	    uSinaEmotionsHt.put('[pt顶起]', '/images/jeck-up.png');
            uSinaEmotionsHt.put('[pt点赞]', '/images/zan_mobile.png');
            uSinaEmotionsHt.put('[pt鼓掌]', '/images/guzhang.png');
            uSinaEmotionsHt.put('[pt鲜花]', '/images/flower.png');
            uSinaEmotionsHt.put('[pt给力]', '/images/geili.gif');
