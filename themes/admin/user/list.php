...
<div class="so_main">
  ...
  <div class="Toolbar_inbox">
	...
	<a  class="btn_a"  href="<?php echo site_url('admin/adminuser/reg_user');?>"><span>增加用户</span></a>
...
function openreg()
{
	$.jBox.open('iframe:<?php echo site_url("admin/user/reg");?>', "用户添加", 500, 420, { buttons: { '关闭': true} });
}
