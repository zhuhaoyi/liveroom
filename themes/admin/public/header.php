...
<link href="<?php echo base_url($this->_d['cfg']['tpl_admin'])?>/css/style.css" rel="stylesheet" type="text/css">
<link href="<?php echo base_url($this->_d['cfg']['tpl_admin'])?>/css/public.css" rel="stylesheet" type="text/css">
<link href="<?php echo base_url($this->_d['cfg']['comm'])?>/js/jBox/Skins/Blue/jbox.css" rel="stylesheet" type="text/css">
